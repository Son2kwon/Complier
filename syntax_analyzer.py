...
action_table = {
    ...
    (16, 'semi'): ('reduce', 10),
    (17, 'semi'): ('reduce', 11),
    (18, 'semi'): ('reduce', 12),   (18, 'rparen'): ('reduce', 12),    (18, 'addsub'): ('reduce', 12),    (18, 'multdiv'): ('shift', 26),
    ...
    (65, 'vtype'): ('shift', 41),    (65, 'id'): ('shift', 42),    (65, 'rbrace'): ('reduce', 24),    (65, 'if'): ('shift', 37),    (65, 'while'): ('shift', 38),    (65, 'return'): ('reduce', 24),
    (66, 'rbrace'): ('shift', 68),
    (67, 'rbrace'): ('shift', 69),
